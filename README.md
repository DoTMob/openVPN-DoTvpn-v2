...
Arch Linux	grey_question	white_check_mark	grey_question	grey_question
...
Fedora 28	grey_question	white_check_mark	grey_question	grey_question
Ubuntu 16.04	white_check_mark	white_check_mark	x	x
Ubuntu 18.04	x	white_check_mark	white_check_mark	white_check_mark
Ubuntu 19.04	x	white_check_mark	white_check_mark	white_check_mark
...
Linux: The openvpn package from your distribution. There is an official APT repository for Debian/Ubuntu based distributions.
macOS: Tunnelblick.
Android: OpenVPN for Android.
iOS: The official OpenVPN Connect client.
